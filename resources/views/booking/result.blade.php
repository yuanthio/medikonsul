...
<div class="max-w-4xl mx-auto">
    <!-- Success Header -->
    <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 mb-8 shadow-traveloka">
        <div class="text-center">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl mb-6">
                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 12l2 2 4-4"></path>
                </svg>
            </div>
            
            <h1 class="text-3xl font-bold text-gray-900 mb-4">Booking Ditemukan!</h1>
            <p class="text-lg text-secondary-600">Berikut adalah detail booking Anda</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-traveloka-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-primary-500 to-primary-600 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-bold text-white mb-1">📋 Detail Booking</h2>
                            <p class="text-primary-100 text-sm">Informasi lengkap booking Anda</p>
                        </div>
                ...
                <div class="p-8">
                    <div class="bg-gradient-to-r from-primary-50 to-blue-50 rounded-2xl p-6 border border-primary-200">
                        <div class="text-center mb-4">
                            ...
                            <div class="bg-white rounded-xl p-6 border-2 border-dashed border-primary-300 shadow-sm">
                                <div class="flex items-center justify-center space-x-4">
                                    <div class="text-3xl font-mono font-bold text-primary-600 tracking-wider">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                            ...
                            <div class="bg-white rounded-xl p-4 border border-secondary-100 md:col-span-2">
                                <div class="flex items-center mb-2">
                                    <div class="w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-sm font-medium text-secondary-500">Email</span>
                                </div>
                                <div class="font-semibold text-gray-900 ml-11">{{ $booking->email }}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-traveloka-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="/check-booking" class="group w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r from-secondary-500 to-secondary-600 hover:from-secondary-600 hover:to-secondary-700 text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]">
                    ...
                    <a href="/" class="group w-full flex items-center justify-center px-6 py-4 bg-white border-2 border-secondary-200 hover:border-primary-300 text-secondary-700 hover:text-primary-700 font-semibold rounded-xl transition-all duration-200">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function copyBookingCode(event) {
    ...
    const bookingCodeElement = event.currentTarget.parentElement.querySelector('.font-mono');
